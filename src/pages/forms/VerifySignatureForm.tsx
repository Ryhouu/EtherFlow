...
import { getContractExpiration, getContractRecipient, getEthBalance, verifySignerIsSender } from "../../../contracts/utils";
        ...
        const fetchData = async () => {
            ...
            if (verifyContractResult.ok) {
                try {
                    ...
                    const balance = await getEthBalance({ contractAddress, etherscanApiKey })
